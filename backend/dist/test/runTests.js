...
const ValidationHelper_1 = require("./test/ValidationHelper");
async function runTests() {
    console.log('Starting tests...');
    try {
        // Setup test data
        console.log('Setting up test data...');
        const testData = await ValidationHelper_1.TestHelper.setupTestData();
        // Test Device model
        console.log('Testing Device model...');
        const device = testData.device;
        const validationErrors = ValidationHelper_1.ValidationHelper.validateDevice(device);
        ...
        const teamValidationErrors = ValidationHelper_1.ValidationHelper.validateTeam(team);
        ...
        const phoneValidationErrors = ValidationHelper_1.ValidationHelper.validatePhone(phone);
        ...
        const userValidationErrors = ValidationHelper_1.ValidationHelper.validateUser(user);
        ...
        await ValidationHelper_1.TestHelper.cleanupTestData();
